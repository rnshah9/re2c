...
%Finally, in appendix the reader can find a sketch of correctness proof.
...
Then compute reachabitlity of the default state by doing backward propagation from states that have transitions to it.
...
%clearly, optimizations play a very important part in any performance-sensitive TDFA implemetation.
